            ...
            <div class="flex">
                ...
                @foreach ($nav_links as $nav_link)
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex ">
                         <x-jet-nav-link class="text-white" href="{{ $nav_link['route'] }}" :active="$nav_link['active']">
                            {{ $nav_link['name'] }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @foreach ($nav_links as $nav_link)
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link class="text-white" href="{{ $nav_link['route'] }}" :active="$nav_link['active']">
                    {{ $nav_link['name'] }}
